...
import {
  ...
  logout as logoutApi,
  signup as signupApi,
  forgotPassword as forgotuserPasswordApi,
} from "../../helpers/";
 ...
 */
function* login({ payload: { userEmail, userPassword } }: UserData): any {
  try {
...
export function* watchForgotuserPassword(): any {
  yield takeEvery(AuthActionTypes.FORGOT_PASSWORD, forgotuserPassword);
}
