...
import { addService } from "../../helpers/serviceCatalogueAPIs";
...
function AddServiceCatelogue(props: any) {
  // Usestate for all the form field values are defined here!
  ...
  // Function to handle the single input changes in the form!
  ...
  function handleSubmit(e: any) {
    e.preventDefault();
    const getData = async () => {
      const response = await addService(formValues);
              ...
              >
                    ...
                    <div className="col-md-6">
                      ...
                      <button
                        ...
                        onClick={() =>
                          setFormValues((prevFormValues) => ({
                            ...prevFormValues,
                            serviceScope: [...prevFormValues.serviceScope, ""],
                          }))
                        }
                      >
                        Add Scope
                        ...
                        onClick={() =>
                          setFormValues((prevFormValues) => ({
                            ...
                            productDescription: {
                              ...prevFormValues.productDescription,
                              keyPoints: [
                                ...prevFormValues.productDescription.keyPoints,
                                "",
                              ],
                            },
                          }))
                ...
                <div className="mb-3">
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      <label className="form-label"> Service Exclusions </label>
                      {formValues.serviceExclusions.map((Exclusions, index) => (
                        <input
                          className="form-label form-control"
                          required
...
export default AddServiceCatelogue;
