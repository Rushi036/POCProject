...
export const NavPills = (props: any) => {
  ...
  return (
    <Card>
      <Card.Body>
        ...
        <Tab.Container defaultActiveKey="Profile">
          <Nav as="ul" justify variant="pills" className="p-1 bg-abgcolor">
            {(props.moduleName || []).map((item: any, index: number) => {
              return (
                <Nav.Item as="li" key={index}>
                  <Nav.Link className="cursor-pointer" eventKey={item}>
                    {/* <span className="d-block d-sm-none">
                      <i className={tab.icon}></i>
                    </span> */}
          ...
          <Tab.Content className="text-muted">
            {(props.moduleName || []).map((item: any, index: number) => {
              return (
                <Tab.Pane eventKey={item} id={String(index)} key={index}>
                  <p>Service Catalog</p>
                </Tab.Pane>
              );
            })}
